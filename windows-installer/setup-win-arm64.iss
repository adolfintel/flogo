...
SetupIconFile=..\electron\icons\winicon.ico
...
[Files]
Source: "..\release\win-arm64-unpacked\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKLM; Subkey: "Software\Classes\Flogo Program\DefaultIcon"; ValueType: string; ValueData: "{app}\resources\icons\winicon_file.ico"; Flags: uninsdeletekey
